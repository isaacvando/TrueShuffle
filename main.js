...
var $author$project$Main$clientId = '0cdc0205c0184f809fa13c8f71d7848c';
...
var $author$project$Main$homeUrl = _Utils_update(
	...
	{host: '127.0.0.1:5500/index.html', protocol: $elm$url$Url$Http});
...
var $author$project$Main$authUrl = $truqu$elm_oauth2$OAuth$AuthorizationCode$makeAuthorizationUrl(
	{
...
var $author$project$Main$clientSecret = 'c14d1577b0e647d481170aa6192021f0';
...
var $author$project$Main$getAuthToken = function (code) {
	return $elm$http$Http$request(
		A2(
			...
			$author$project$Main$GotAccessToken,
			{
				...
				credentials: {
					clientId: $author$project$Main$clientId,
					secret: $elm$core$Maybe$Just($author$project$Main$clientSecret)
				},
				redirectUri: $author$project$Main$homeUrl,
				url: _Utils_update(
					$author$project$Main$defaultHttpsUrl,
...
var $author$project$Main$Playlist = F5(
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		...
		if (_v0.$ === 'Success') {
			...
			return _Utils_Tuple2(
				model,
				$author$project$Main$getAuthToken(code));
		} else {
			return _Utils_Tuple2(
				model,
...
var $author$project$Main$viewPlaylist = function (p) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
